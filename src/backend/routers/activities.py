...
def get_activities(
    ...
    - difficulty: Filter by difficulty ('beginner', 'intermediate', 'advanced', or 'all' for activities with no difficulty specified)
    """
    ...
    if difficulty:
        ...
        if normalized_difficulty == "all":
            ...
            query["difficulty"] = normalized_difficulty.title()
